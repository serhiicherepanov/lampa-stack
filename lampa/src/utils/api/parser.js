...
function prowlarr(params = {}, oncomplite, onerror){
    ...
    if(!params.from_search){
        ...
        /** Prowlarr принимает категории только повторяющимся параметром, '2000,5070' отдает 400 */
        u.searchParams.append('categories', params.movie.number_of_seasons > 0 ? 5000 : 2000);

        if(params.movie.original_language == 'ja') u.searchParams.append('categories', 5070);
